...
WSGI_APPLICATION = 'contratid.wsgi.application'
ASGI_APPLICATION = 'contratid.asgi.application'
...
DATABASES = {
    'default': dj_database_url.config(
        default=config(
            'DATABASE_URL',
            default='postgres://uid:contratid_dev@db:5432/contratid'
        ),
        conn_max_age=600,
    )
}
